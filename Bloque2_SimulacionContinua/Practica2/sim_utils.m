function [cfg, model_names, constants] = sim_utils()
    % MODELS
    model_names = {'Problema4', 'Problema5'};
    constants = {
        struct(y0=1, dy0=2, d2y0=3, d3y0=4), ...
        struct(Cc=30, mc=60, mr=12, Kc=20, Kr=700), ...
    };

    % SOLVER CONFIGS
    SolverTypes = {'Variable-Step', 'Variable-Step',};
    SolverNames = {'ode45', 'ode45',};
    StartTimes = {0, 0, };
    FixedSteps = {1, 1, };
    StopTimes = {50, 10, };
